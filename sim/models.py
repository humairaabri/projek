...
class Tmahasiswa(db.Model, UserMixin): #tambahka
...
class Tpengaduan(db.Model):
    ...
    katagori = db.Column(db.String(50), nullable=False)
    ...
    def __repr__(self):
        return f"Tpengaduan('{self.subjek}','{self.katagori}','{self.detail_pengaduan}','{self.tgl_post}')"